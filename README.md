...
SaaS для финансового моделирования предприятия: расчётное ядро, REST-API и веб-клиент.

Сверх расчёта — **ревью бизнес-плана** (Ф10): детерминированный «линтер модели»,
