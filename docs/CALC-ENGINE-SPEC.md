...
- **Лизинг** `C25`: операционный лизинг реализован в 0.8.7 (`Financing.leases`) —
  ...
  **Страхование** предмета (0.9.13, `insurance_monthly`): помесячная издержка `I21` + отток
  ...
  обязательства лизинга — к сверке по эталону.
...
> инструментов размещения (сроки/типы) — к сверке по эталону.
...
3. **Курсовая разница `I25`:** перечень переоцениваемых статей и знак.
   ...
   **валютных займов** (`Loan.foreign`, `0.8.1`), **экспортной выручки**
   ...
   реализационный учёт налога на курсовую разницу — к сверке по эталону.
