...
#: Название продукта для человека. Держится рядом с каталогом, а не в тексте сообщений:
#: подписи «подписка на business не оплачена» клиент про себя не переведёт.
PRODUCT_NAME: dict[str, str] = {"business": "Финанс-Элит", "audit": "Финанс-Аудит"}
