...
export function efficiencyCards(m: MetricsOut, discountRate?: string | null): MetricCard[] {
  ...
  return [
    ...
    },
    {
      ...
      // в значении стоит наибольший накопленный дефицит в деньгах горизонта, а
      // дисконтированная величина — в подписи под ним. Числа на карточке два, и
      // называть их одним именем значит утверждать о деньгах больше, чем посчитано.
      hint: "Наибольший накопленный дефицит денег за горизонт — сколько капитала нужно "
            + "привлечь, чтобы касса не ушла в минус. Без дисконтирования; приведённая "
            + "величина этого же графика — в подписи «PV инвестиций».",
    },
  ];
}
