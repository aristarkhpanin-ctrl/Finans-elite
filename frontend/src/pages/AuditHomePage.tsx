      ...
      {isLoading ? (
        ...
        <div className="tab-empty">
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
            {/* Первое дело заводится мастером: он спрашивает ещё и периоды, без
                которых вводить нечего, и сразу зовёт коллег. Быстрая модалка
                остаётся кнопкой в шапке — для второго и последующих дел. */}
            <Button onClick={() => navigate("/audit/onboarding")}>
              Настроить пространство
            </Button>
            <Button variant="ghost" onClick={openCreate}>Создать дело</Button>
