...
const ACTION: Record<string, string> = {
  ...
  "member.invite_mail": "Письмо-приглашение участнику",
  "benchmarks.replace": "Изменены отраслевые ориентиры",
  "checklists.replace": "Изменены чек-листы процедур",
  "audit_log.export": "Журнал выгружен",
  "org.export": "Выгружены данные организации",
  "org.transfer_ownership": "Передано владение организацией",
  "apikey.create": "Выпущен ключ доступа к API",
  "apikey.revoke": "Отозван ключ доступа к API",
  // Оплата
  "billing.checkout": "Смена тарифа через оплату",
  "billing.plan_change": "Изменён тариф",
  "billing.overdue": "Период и льготный срок истекли",
  "billing.reminder": "Письмо об оплате",
  "billing.reminder_failed": "Письмо об оплате не ушло",
  "billing.auto_renew_on": "Автопродление включено",
  ...
  "staff.audit_log_view": "Платформа: просмотр журнала",
  "staff.org_suspend": "Организация приостановлена платформой",
  "staff.org_resume": "Приостановка снята платформой",
  "staff.plan_assign": "Тариф назначен платформой",
  "staff.user_block": "Учётная запись заблокирована платформой",
  "staff.user_unblock": "Учётная запись разблокирована платформой",
  "staff.totp_reset": "Второй фактор сброшен платформой",
  "support.grant": "Открыт доступ поддержки к моделям",
  "support.revoke": "Закрыт доступ поддержки к моделям",
  "support.projects_list": "Поддержка по доступу: список проектов",
  "support.project_view": "Поддержка по доступу: просмотр проекта",
  "support.cases_list": "Поддержка по доступу: список дел",
  "support.case_view": "Поддержка по доступу: просмотр дела",
  // Обсуждения
  "comment.mention_mail": "Письмо об упоминании в обсуждении",
  "comment.reply_mail": "Письмо об ответе в обсуждении",
  // «Финанс-Элит»
  ...
  "auth.login_blocked": "Попытка входа заблокированной учётной записи",
  "auth.session_revoke": "Закрыт сеанс входа",
  "auth.sessions_revoke_all": "Закрыты все сеансы входа",
  "auth.new_device_notice": "Письмо о входе с нового устройства",
  "auth.email_verification_sent": "Письмо для подтверждения почты",
  "auth.email_verified": "Почта подтверждена",
  "auth.totp_enabled": "Включён второй фактор",
  "auth.totp_disabled": "Выключен второй фактор",
  "auth.totp_failed": "Неверный код второго фактора",
  "auth.totp_recovery_used": "Вход по резервному коду",
  "auth.totp_recovery_reissued": "Перевыпущены резервные коды",
  "user.data_export": "Выгружены свои персональные данные",
...
const TONE: Record<string, string> = {
  ...
  "auth.login_blocked": "log-row--danger",
  "auth.totp_failed": "log-row--danger",
  "staff.org_suspend": "log-row--danger",
  "staff.user_block": "log-row--danger",
  "billing.overdue": "log-row--danger",
  "billing.reminder_failed": "log-row--danger",
  "billing.auto_renew_failed": "log-row--danger",
  "user.delete": "log-row--danger",
  ...
  "staff.totp_reset": "log-row--attn",
  "support.projects_list": "log-row--attn",
  "support.project_view": "log-row--attn",
  "support.cases_list": "log-row--attn",
  "support.case_view": "log-row--attn",
  "apikey.create": "log-row--attn",
  "auth.totp_disabled": "log-row--attn",
};
