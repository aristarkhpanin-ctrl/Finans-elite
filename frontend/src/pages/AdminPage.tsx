...
function MetricsTab() {
  ...
  return (
    <div>
      ...
      {!churn.expiry_logged && (
        <div className="page-sub">
          <b>Уход по окончании периода не измеряется.</b> Записей нет вовсе: сверку
          неоплаты ни разу не проводили — ни планировщик (процесс beat не запущен), ни
          вручную <code>scripts/expire_subscriptions.py</code>. Ноль здесь означал бы
          «никто не уходит», а это другое утверждение.
        </div>
      )}
