...
const ALIASES: Record<string, string> = {
  ...
  AuditSummary: "AuditSummaryOut",
  AuditValuation: "AuditValuationOut",
  AuditRisk: "AuditRiskOut",
  AuditPlanFact: "AuditPlanFactOut",
  AuditPlanFactRow: "AuditPlanFactRowOut",
  AuditRealizedFlag: "AuditRealizedFlagOut",
  AuditComparison: "AuditCompareResponse",
  AuditCaseColumn: "AuditCaseColumnOut",
  AuditCompareRow: "AuditCompareRowOut",
  AuditTornadoBar: "AuditTornadoBarOut",
  AuditMonteCarlo: "AuditMonteCarloOut",
  AuditHistogramBin: "AuditHistogramBinOut",
  AuditForecastYear: "AuditForecastYearOut",
  AuditBridgeItem: "AuditBridgeItemOut",
  AuditHeadMetric: "AuditHeadMetricOut",
